...
<div class="rounded-3xl shadow-xl w-full overflow-hidden max-w-screen-xl md:flex">
    <div
        ...
        <h1 class="font-bold text-4xl md:text-5xl text-white mb-4">Welcome Back, Artist!</h1>
        <p class="text-lg text-slate-300 mb-4">We're excited to have you back on our platform! Your passion for art and your commitment to collaboration enriches our creative community.</p>
        <a href="/"
