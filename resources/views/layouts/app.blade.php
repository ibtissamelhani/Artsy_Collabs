            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        <img src="{{ asset('images/logo-w.png') }}" class="h-12 me-3" alt="FlowBite Logo" />
                        <span class="self-center text-xl font-serif sm:text-2xl whitespace-nowrap	 dark:text-white">ArtsyCollabs</span>
                    </a>
                </div>
                    ...
                    <div class="flex items-center ms-3">
                        <div>
                            <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                                ...
                                <img class="w-10 h-10 rounded-full" src="{{ Auth::user()->getFirstMediaUrl('profiles')}}" alt="user photo">
                            </button>
                        </div>
